...
To play this version against our AI, you will need to install tkinter, pillow, torch, torchvision, colorthief, and CLIP (instruction on this github: https://github.com/openai/CLIP)
Update the Pathroot in OuiSiGUI to the path to your OuiSi folder
